...
public:
    ...
    LMDBCommonOperations(const std::string& dbName): _dbName{dbName} {}
...
protected:
    ...
    LMDBBasicOperations(): LMDBCommonOperations{"./test_basic_operations.db"} {}
...
protected:
    ...
    LMDBCursorOperations(): LMDBCommonOperations{"./test_cursor_operations.db"} {}
