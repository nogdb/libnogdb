...
void indexAdjacentConditionTester(nogdb::Context *ctx, const std::string& className, const std::string& propertyName,
    ...
    try {
        auto txn = nogdb::Txn{*ctx, nogdb::Txn::Mode::READ_ONLY};
        auto res = nogdb::Vertex::getIndex(txn, className, nogdb::Condition(propertyName).between(firstMid + 1, secondMid + 1));
        assert(rdescCompare(propertyName, res, {rdescSecondMid}));
...
template<typename T>
void nonUniqueIndexAdjacentConditionTester(nogdb::Context *ctx, const std::string& className, const std::string& propertyName,
                                   const nogdb::RecordDescriptor& rdescMin1, const nogdb::RecordDescriptor& rdescMin2, const T& min,
                                   const nogdb::RecordDescriptor& rdescFirstMid1, const nogdb::RecordDescriptor& rdescFirstMid2, const T& firstMid,
                                   const nogdb::RecordDescriptor& rdescSecondMid1, const nogdb::RecordDescriptor& rdescSecondMid2, const T& secondMid,
                                   const nogdb::RecordDescriptor& rdescMax1, const nogdb::RecordDescriptor& rdescMax2, const T& max) {
    ...
    try {
        ...
        assert(rdescCompare(propertyName, res, {rdescMin1, rdescFirstMid1, rdescSecondMid1, rdescMin2, rdescFirstMid2, rdescSecondMid2}));
        res = nogdb::Vertex::getIndex(txn, className, nogdb::Condition(propertyName).le(max + 1));
        assert(rdescCompare(propertyName, res, {rdescMin1, rdescFirstMid1, rdescSecondMid1, rdescMin2, rdescFirstMid2, rdescSecondMid2, rdescMax1, rdescMax2}));
    } catch (const nogdb::Error &ex) {
        std::cout << "\nError: " << ex.what() << std::endl;
        assert(false);
    }
    ...
    try {
        auto txn = nogdb::Txn{*ctx, nogdb::Txn::Mode::READ_ONLY};
        auto res = nogdb::Vertex::getIndex(txn, className, nogdb::Condition(propertyName).ge(min - 1));
        assert(rdescCompare(propertyName, res, {rdescMax1, rdescFirstMid1, rdescSecondMid1, rdescMin1, rdescMax2, rdescFirstMid2, rdescSecondMid2, rdescMin2}));
        res = nogdb::Vertex::getIndex(txn, className, nogdb::Condition(propertyName).ge(firstMid - 1));
        assert(rdescCompare(propertyName, res, {rdescMax1, rdescFirstMid1, rdescSecondMid1, rdescMax2, rdescFirstMid2, rdescSecondMid2}));
        res = nogdb::Vertex::getIndex(txn, className, nogdb::Condition(propertyName).ge(secondMid - 1));
        assert(rdescCompare(propertyName, res, {rdescMax1, rdescSecondMid1, rdescMax2, rdescSecondMid2}));
    ...
    try {
        ...
        assert(rdescCompare(propertyName, res, {rdescMin1, rdescMin2, rdescFirstMid1, rdescFirstMid2}));
        res = nogdb::Vertex::getIndex(txn, className, nogdb::Condition(propertyName).between(min - 1, secondMid + 1));
        assert(rdescCompare(propertyName, res, {rdescMin1, rdescMin2, rdescFirstMid1, rdescSecondMid1, rdescFirstMid2, rdescSecondMid2}));
    } catch (const nogdb::Error &ex) {
        std::cout << "\nError: " << ex.what() << std::endl;
        assert(false);
    }
    ...
    try {
        ...
        res = nogdb::Vertex::getIndex(txn, className, nogdb::Condition(propertyName).between(firstMid - 1, max + 1));
        assert(rdescCompare(propertyName, res, {rdescFirstMid1, rdescSecondMid1, rdescFirstMid2, rdescSecondMid2, rdescMax1, rdescMax2}));
    } catch (const nogdb::Error &ex) {
        std::cout << "\nError: " << ex.what() << std::endl;
        assert(false);
    }
