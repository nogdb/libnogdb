...
void test_create_index_with_records()
{
    ...
    try {
        auto txn = ctx->beginTxn(nogdb::TxnMode::READ_WRITE);
        txn.addVertex("index_test", nogdb::Record {}.set("index_text", "aaa").set("index_tinyint_u", uint8_t { 1 }).set("index_tinyint", int8_t { -1 }).set("index_smallint_u", uint16_t { 10 }).set("index_smallint", int16_t { -10 }).set("index_int_u", uint32_t { 100 }).set("index_int", int32_t { -100 }).set("index_bigint_u", uint64_t { 1000 }).set("index_bigint", int64_t { -1000 }).set("index_real", 2.0));
        txn.addVertex("index_test", nogdb::Record {}.set("index_text", "ccc").set("index_tinyint_u", uint8_t { 2 }).set("index_tinyint", int8_t { 2 }).set("index_smallint_u", uint16_t { 20 }).set("index_smallint", int16_t { 20 }).set("index_int_u", uint32_t { 200 }).set("index_int", int32_t { 200 }).set("index_bigint_u", uint64_t { 2000 }).set("index_bigint", int64_t { 2000 }).set("index_real", 8.4));
        txn.addVertex("index_test", nogdb::Record {}.set("index_text", "bbb").set("index_tinyint_u", uint8_t { 0 }).set("index_tinyint", int8_t { 0 }).set("index_smallint_u", uint16_t { 0 }).set("index_smallint", int16_t { 0 }).set("index_int_u", uint32_t { 0 }).set("index_int", int32_t { 0 }).set("index_bigint_u", uint64_t { 0 }).set("index_bigint", int64_t { 0 }).set("index_real", 0.0));
        txn.addVertex("index_test", nogdb::Record {}.set("index_text", "zz").set("index_tinyint_u", uint8_t { 1 }).set("index_tinyint", int8_t { -123 }).set("index_smallint_u", uint16_t { 10 }).set("index_smallint", int16_t { -123 }).set("index_int_u", uint32_t { 100 }).set("index_int", int32_t { -123123123 }).set("index_bigint_u", uint64_t { 1000 }).set("index_bigint", int64_t { -123123123 }).set("index_real", 2.0));
        txn.commit();
    } catch (const nogdb::Error& ex) {
        std::cout << "\nError: " << ex.what() << std::endl;
        assert(false);
...
void test_create_index_extended_class_with_records()
{
    ...
    try {
        auto txn = ctx->beginTxn(nogdb::TxnMode::READ_WRITE);
        txn.addVertex("index_test_2", nogdb::Record {}.set("index_text", "aaa").set("index_tinyint_u", uint8_t { 1 }).set("index_tinyint", int8_t { -1 }).set("index_smallint_u", uint16_t { 10 }).set("index_smallint", int16_t { -10 }).set("index_int_u", uint32_t { 100 }).set("index_int", int32_t { -100 }).set("index_bigint_u", uint64_t { 1000 }).set("index_bigint", int64_t { -1000 }).set("index_real", 2.0).set("index_text_2", "AAA").set("index_int_2", int32_t { -999 }));
        txn.addVertex("index_test_2", nogdb::Record {}.set("index_text", "ccc").set("index_tinyint_u", uint8_t { 2 }).set("index_tinyint", int8_t { 2 }).set("index_smallint_u", uint16_t { 20 }).set("index_smallint", int16_t { 20 }).set("index_int_u", uint32_t { 200 }).set("index_int", int32_t { 200 }).set("index_bigint_u", uint64_t { 2000 }).set("index_bigint", int64_t { 2000 }).set("index_real", 8.4).set("index_text_2", "ZZZ").set("index_int_2", int32_t { 99999 }));
        txn.addVertex("index_test_2", nogdb::Record {}.set("index_text", "bbb").set("index_tinyint_u", uint8_t { 0 }).set("index_tinyint", int8_t { 0 }).set("index_smallint_u", uint16_t { 0 }).set("index_smallint", int16_t { 0 }).set("index_int_u", uint32_t { 0 }).set("index_int", int32_t { 0 }).set("index_bigint_u", uint64_t { 0 }).set("index_bigint", int64_t { 0 }).set("index_real", 0.0).set("index_text_2", ".").set("index_int_2", int32_t { 0 }));
        txn.addVertex("index_test_2", nogdb::Record {}.set("index_text", "bbb").set("index_tinyint_u", uint8_t { 123 }).set("index_tinyint", int8_t { 0 }).set("index_smallint_u", uint16_t { 123 }).set("index_smallint", int16_t { 0 }).set("index_int_u", uint32_t { 123123 }).set("index_int", int32_t { 0 }).set("index_bigint_u", uint64_t { 123123123 }).set("index_bigint", int64_t { 0 }).set("index_real", 123.123).set("index_text_2", "helloworld").set("index_int_2", int32_t { 0 }));
        txn.commit();
    } catch (const nogdb::Error& ex) {
        std::cout << "\nError: " << ex.what() << std::endl;
        assert(false);
...
void test_create_invalid_index_with_records()
{
    ...
    try {
        auto txn = ctx->beginTxn(nogdb::TxnMode::READ_WRITE);
        txn.addVertex("index_test_3", nogdb::Record {}.set("index_text", "aaa").set("index_tinyint_u", uint8_t { 1 }).set("index_tinyint", int8_t { -1 }).set("index_smallint_u", uint16_t { 10 }).set("index_smallint", int16_t { -10 }).set("index_int_u", uint32_t { 100 }).set("index_int", int32_t { -100 }).set("index_bigint_u", uint64_t { 1000 }).set("index_bigint", int64_t { -1000 }).set("index_real", 2.0));
        txn.addVertex("index_test_3", nogdb::Record {}.set("index_text", "ccc").set("index_tinyint_u", uint8_t { 2 }).set("index_tinyint", int8_t { 2 }).set("index_smallint_u", uint16_t { 20 }).set("index_smallint", int16_t { 20 }).set("index_int_u", uint32_t { 200 }).set("index_int", int32_t { 200 }).set("index_bigint_u", uint64_t { 2000 }).set("index_bigint", int64_t { 2000 }).set("index_real", 8.4));
        txn.addVertex("index_test_3", nogdb::Record {}.set("index_text", "aaa").set("index_tinyint_u", uint8_t { 1 }).set("index_tinyint", int8_t { -1 }).set("index_smallint_u", uint16_t { 10 }).set("index_smallint", int16_t { -10 }).set("index_int_u", uint32_t { 100 }).set("index_int", int32_t { -100 }).set("index_bigint_u", uint64_t { 1000 }).set("index_bigint", int64_t { -1000 }).set("index_real", 2.0));
        txn.commit();
    } catch (const nogdb::Error& ex) {
...
void test_search_by_index_unique_condition()
{
    ...
    try {
        auto txn = ctx->beginTxn(nogdb::TxnMode::READ_WRITE);
        rdesc1 = txn.addVertex("index_test", nogdb::Record {}.set("index_text", "abcdefghijklmnopqrstuvwxyz").set("index_tinyint_u", std::numeric_limits<uint8_t>::max() - uint8_t { 1 }).set("index_tinyint", std::numeric_limits<int8_t>::max() - int8_t { 1 }).set("index_smallint_u", std::numeric_limits<uint16_t>::max() - uint16_t { 1 }).set("index_smallint", std::numeric_limits<int16_t>::max() - int16_t { 1 }).set("index_int_u", std::numeric_limits<uint32_t>::max() - uint32_t { 1 }).set("index_int", std::numeric_limits<int32_t>::max() - int32_t { 1 }).set("index_bigint_u", std::numeric_limits<uint64_t>::max() - uint64_t { 1 }).set("index_bigint", std::numeric_limits<int64_t>::max() - int64_t { 1 }).set("index_real", 12345.6789));
        rdesc2 = txn.addVertex("index_test", nogdb::Record {}.set("index_text", "0123456789").set("index_tinyint_u", std::numeric_limits<uint8_t>::min() + uint8_t { 1 }).set("index_tinyint", std::numeric_limits<int8_t>::min() + int8_t { 1 }).set("index_smallint_u", std::numeric_limits<uint16_t>::min() + uint16_t { 1 }).set("index_smallint", std::numeric_limits<int16_t>::min() + int16_t { 1 }).set("index_int_u", std::numeric_limits<uint32_t>::min() + uint32_t { 1 }).set("index_int", std::numeric_limits<int32_t>::min() + int32_t { 1 }).set("index_bigint_u", std::numeric_limits<uint64_t>::min() + uint64_t { 1 }).set("index_bigint", std::numeric_limits<int64_t>::min() + int64_t { 1 }).set("index_real", -12345.6789));
        rdesc3 = txn.addVertex("index_test", nogdb::Record {}.set("index_text", "__lib_c++__").set("index_tinyint_u", std::numeric_limits<uint8_t>::max() / 2).set("index_tinyint", int8_t { 0 }).set("index_smallint_u", std::numeric_limits<uint16_t>::max() / 2).set("index_smallint", int16_t { 0 }).set("index_int_u", std::numeric_limits<uint32_t>::max() / 2).set("index_int", int32_t { 0 }).set("index_bigint_u", std::numeric_limits<uint64_t>::max() / 2).set("index_bigint", int64_t { 0 }).set("index_real", 1.001));
        rdesc4 = txn.addVertex("index_test", nogdb::Record {}.set("index_text", "Hello, World").set("index_tinyint_u", std::numeric_limits<uint8_t>::max() / 4).set("index_tinyint", int8_t { -2 }).set("index_smallint_u", std::numeric_limits<uint16_t>::max() / 4).set("index_smallint", int16_t { -2 }).set("index_int_u", std::numeric_limits<uint32_t>::max() / 4).set("index_int", int32_t { -2 }).set("index_bigint_u", std::numeric_limits<uint64_t>::max() / 4).set("index_bigint", int64_t { -2 }).set("index_real", -0.001));
        txn.commit();
    } catch (const nogdb::Error& ex) {
        std::cout << "\nError: " << ex.what() << std::endl;
        assert(false);
...
void test_search_by_index_non_unique_condition()
{
    ...
    try {
        auto txn = ctx->beginTxn(nogdb::TxnMode::READ_WRITE);
        rdesc11 = txn.addVertex("index_test", nogdb::Record {}.set("index_text", "abcdefghijklmnopqrstuvwxyz").set("index_tinyint_u", std::numeric_limits<uint8_t>::max() - uint8_t { 1 }).set("index_tinyint", std::numeric_limits<int8_t>::max() - int8_t { 1 }).set("index_smallint_u", std::numeric_limits<uint16_t>::max() - uint16_t { 1 }).set("index_smallint", std::numeric_limits<int16_t>::max() - int16_t { 1 }).set("index_int_u", std::numeric_limits<uint32_t>::max() - uint32_t { 1 }).set("index_int", std::numeric_limits<int32_t>::max() - int32_t { 1 }).set("index_bigint_u", std::numeric_limits<uint64_t>::max() - uint64_t { 1 }).set("index_bigint", std::numeric_limits<int64_t>::max() - int64_t { 1 }).set("index_real", 12345.6789));
        rdesc21 = txn.addVertex("index_test", nogdb::Record {}.set("index_text", "0123456789").set("index_tinyint_u", std::numeric_limits<uint8_t>::min() + uint8_t { 1 }).set("index_tinyint", std::numeric_limits<int8_t>::min() + int8_t { 1 }).set("index_smallint_u", std::numeric_limits<uint16_t>::min() + uint16_t { 1 }).set("index_smallint", std::numeric_limits<int16_t>::min() + int16_t { 1 }).set("index_int_u", std::numeric_limits<uint32_t>::min() + uint32_t { 1 }).set("index_int", std::numeric_limits<int32_t>::min() + int32_t { 1 }).set("index_bigint_u", std::numeric_limits<uint64_t>::min() + uint64_t { 1 }).set("index_bigint", std::numeric_limits<int64_t>::min() + int64_t { 1 }).set("index_real", -12345.6789));
        rdesc31 = txn.addVertex("index_test", nogdb::Record {}.set("index_text", "__lib_c++__").set("index_tinyint_u", std::numeric_limits<uint8_t>::max() / 2).set("index_tinyint", int8_t { 0 }).set("index_smallint_u", std::numeric_limits<uint16_t>::max() / 2).set("index_smallint", int16_t { 0 }).set("index_int_u", std::numeric_limits<uint32_t>::max() / 2).set("index_int", int32_t { 0 }).set("index_bigint_u", std::numeric_limits<uint64_t>::max() / 2).set("index_bigint", int64_t { 0 }).set("index_real", 1.001));
        rdesc41 = txn.addVertex("index_test", nogdb::Record {}.set("index_text", "Hello, World").set("index_tinyint_u", std::numeric_limits<uint8_t>::max() / 4).set("index_tinyint", int8_t { -2 }).set("index_smallint_u", std::numeric_limits<uint16_t>::max() / 4).set("index_smallint", int16_t { -2 }).set("index_int_u", std::numeric_limits<uint32_t>::max() / 4).set("index_int", int32_t { -2 }).set("index_bigint_u", std::numeric_limits<uint64_t>::max() / 4).set("index_bigint", int64_t { -2 }).set("index_real", -0.001));
        rdesc12 = txn.addVertex("index_test", nogdb::Record {}.set("index_text", "abcdefghijklmnopqrstuvwxyz").set("index_tinyint_u", std::numeric_limits<uint8_t>::max() - uint8_t { 1 }).set("index_tinyint", std::numeric_limits<int8_t>::max() - int8_t { 1 }).set("index_smallint_u", std::numeric_limits<uint16_t>::max() - uint16_t { 1 }).set("index_smallint", std::numeric_limits<int16_t>::max() - int16_t { 1 }).set("index_int_u", std::numeric_limits<uint32_t>::max() - uint32_t { 1 }).set("index_int", std::numeric_limits<int32_t>::max() - int32_t { 1 }).set("index_bigint_u", std::numeric_limits<uint64_t>::max() - uint64_t { 1 }).set("index_bigint", std::numeric_limits<int64_t>::max() - int64_t { 1 }).set("index_real", 12345.6789));
        rdesc22 = txn.addVertex("index_test", nogdb::Record {}.set("index_text", "0123456789").set("index_tinyint_u", std::numeric_limits<uint8_t>::min() + uint8_t { 1 }).set("index_tinyint", std::numeric_limits<int8_t>::min() + int8_t { 1 }).set("index_smallint_u", std::numeric_limits<uint16_t>::min() + uint16_t { 1 }).set("index_smallint", std::numeric_limits<int16_t>::min() + int16_t { 1 }).set("index_int_u", std::numeric_limits<uint32_t>::min() + uint32_t { 1 }).set("index_int", std::numeric_limits<int32_t>::min() + int32_t { 1 }).set("index_bigint_u", std::numeric_limits<uint64_t>::min() + uint64_t { 1 }).set("index_bigint", std::numeric_limits<int64_t>::min() + int64_t { 1 }).set("index_real", -12345.6789));
        rdesc32 = txn.addVertex("index_test", nogdb::Record {}.set("index_text", "__lib_c++__").set("index_tinyint_u", std::numeric_limits<uint8_t>::max() / 2).set("index_tinyint", int8_t { 0 }).set("index_smallint_u", std::numeric_limits<uint16_t>::max() / 2).set("index_smallint", int16_t { 0 }).set("index_int_u", std::numeric_limits<uint32_t>::max() / 2).set("index_int", int32_t { 0 }).set("index_bigint_u", std::numeric_limits<uint64_t>::max() / 2).set("index_bigint", int64_t { 0 }).set("index_real", 1.001));
        rdesc42 = txn.addVertex("index_test", nogdb::Record {}.set("index_text", "Hello, World").set("index_tinyint_u", std::numeric_limits<uint8_t>::max() / 4).set("index_tinyint", int8_t { -2 }).set("index_smallint_u", std::numeric_limits<uint16_t>::max() / 4).set("index_smallint", int16_t { -2 }).set("index_int_u", std::numeric_limits<uint32_t>::max() / 4).set("index_int", int32_t { -2 }).set("index_bigint_u", std::numeric_limits<uint64_t>::max() / 4).set("index_bigint", int64_t { -2 }).set("index_real", -0.001));
        txn.commit();
    } catch (const nogdb::Error& ex) {
        std::cout << "\nError: " << ex.what() << std::endl;
        assert(false);
...
void test_search_by_index_extended_class_condition()
{
    ...
    try {
        auto txn = ctx->beginTxn(nogdb::TxnMode::READ_WRITE);
        rdesc1 = txn.addVertex("index_test2", nogdb::Record {}.set("index_text", "abcdefghijklmnopqrstuvwxyz").set("index_tinyint_u", std::numeric_limits<uint8_t>::max() - uint8_t { 1 }).set("index_tinyint", std::numeric_limits<int8_t>::max() - int8_t { 1 }).set("index_smallint_u", std::numeric_limits<uint16_t>::max() - uint16_t { 1 }).set("index_smallint", std::numeric_limits<int16_t>::max() - int16_t { 1 }).set("index_int_u", std::numeric_limits<uint32_t>::max() - uint32_t { 1 }).set("index_int", std::numeric_limits<int32_t>::max() - int32_t { 1 }).set("index_bigint_u", std::numeric_limits<uint64_t>::max() - uint64_t { 1 }).set("index_bigint", std::numeric_limits<int64_t>::max() - int64_t { 1 }).set("index_real", 12345.6789));
        rdesc2 = txn.addVertex("index_test2", nogdb::Record {}.set("index_text", "0123456789").set("index_tinyint_u", std::numeric_limits<uint8_t>::min() + uint8_t { 1 }).set("index_tinyint", std::numeric_limits<int8_t>::min() + int8_t { 1 }).set("index_smallint_u", std::numeric_limits<uint16_t>::min() + uint16_t { 1 }).set("index_smallint", std::numeric_limits<int16_t>::min() + int16_t { 1 }).set("index_int_u", std::numeric_limits<uint32_t>::min() + uint32_t { 1 }).set("index_int", std::numeric_limits<int32_t>::min() + int32_t { 1 }).set("index_bigint_u", std::numeric_limits<uint64_t>::min() + uint64_t { 1 }).set("index_bigint", std::numeric_limits<int64_t>::min() + int64_t { 1 }).set("index_real", -12345.6789));
        rdesc3 = txn.addVertex("index_test2", nogdb::Record {}.set("index_text", "__lib_c++__").set("index_tinyint_u", std::numeric_limits<uint8_t>::max() / 2).set("index_tinyint", int8_t { 0 }).set("index_smallint_u", std::numeric_limits<uint16_t>::max() / 2).set("index_smallint", int16_t { 0 }).set("index_int_u", std::numeric_limits<uint32_t>::max() / 2).set("index_int", int32_t { 0 }).set("index_bigint_u", std::numeric_limits<uint64_t>::max() / 2).set("index_bigint", int64_t { 0 }).set("index_real", 1.001));
        rdesc4 = txn.addVertex("index_test2", nogdb::Record {}.set("index_text", "Hello, World").set("index_tinyint_u", std::numeric_limits<uint8_t>::max() / 4).set("index_tinyint", int8_t { -2 }).set("index_smallint_u", std::numeric_limits<uint16_t>::max() / 4).set("index_smallint", int16_t { -2 }).set("index_int_u", std::numeric_limits<uint32_t>::max() / 4).set("index_int", int32_t { -2 }).set("index_bigint_u", std::numeric_limits<uint64_t>::max() / 4).set("index_bigint", int64_t { -2 }).set("index_real", -0.001));
        txn.commit();
    } catch (const nogdb::Error& ex) {
        std::cout << "\nError: " << ex.what() << std::endl;
        assert(false);
