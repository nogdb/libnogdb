...
namespace nogdb {
  ...
  namespace index {
    ...
    public:
      ...
      void
      initialize(const PropertyAccessInfo &propertyInfo, const IndexAccessInfo &indexInfo, const ClassType &classType) {
    ...
    private:
      ...
      std::vector<RecordDescriptor>
      getLessOrEqual(const PropertyAccessInfo &propertyInfo, const IndexAccessInfo &indexInfo,
      ...
      std::vector<RecordDescriptor>
      getGreaterThan(const PropertyAccessInfo &propertyInfo, const IndexAccessInfo &indexInfo,
                     const Bytes &value) const {
      ...
      std::vector<RecordDescriptor>
      getLessCommon(const PropertyAccessInfo &propertyInfo, const IndexAccessInfo &indexInfo, const Bytes &value,
                    bool isEqual) const {
        switch (propertyInfo.type) {
          case PropertyType::UNSIGNED_TINYINT:
          case PropertyType::UNSIGNED_SMALLINT:
      ...
      std::vector<RecordDescriptor>
      getGreaterCommon(const PropertyAccessInfo &propertyInfo, const IndexAccessInfo &indexInfo, const Bytes &value,
                       bool isEqual) const {
        switch (propertyInfo.type) {
          case PropertyType::UNSIGNED_TINYINT:
          case PropertyType::UNSIGNED_SMALLINT:
